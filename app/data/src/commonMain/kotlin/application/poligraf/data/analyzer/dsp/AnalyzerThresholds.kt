 ...
 */
internal object AnalyzerThresholds {
    ...
    const val NOISE_FLOOR_ALPHA = 0.015f      // Slower tracking for stability
    ...
    const val CALIBRATION_TOTAL_FRAMES = 100    // ~5 seconds
    const val CALIBRATION_VOICE_FRAMES = 40     // ~2 seconds of active speech

    // --- Statistical Window & Look-ahead ---
    const val STATS_WINDOW_SIZE = 120         // ~6 seconds of history
    const val LOOKAHEAD_WINDOW_MS = 600L      // 600ms look-ahead to verify anomaly context
    const val WARMUP_DURATION_MS = 5000L      // 5 seconds of calibration profiling at start
