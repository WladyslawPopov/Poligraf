...
fun AnalyzerControls(
    ...
    Row(
        ...
        FloatingActionButton(
            onClick = { if (isAnalyzing) onPauseResume() else onStart() },
            shape = CircleShape,
            containerColor = if (isAnalyzing && !isPaused) designSystem.color(ColorToken.STATE_SUCCESS) else designSystem.color(
            ...
            val icon = when {
                !isAnalyzing -> designSystem.icon(IconToken.MIC)
