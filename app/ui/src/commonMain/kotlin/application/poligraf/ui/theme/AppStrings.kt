...
data class RecorderStrings(
    ...
    val rings: String,
    val statusWarmup: String,
    val statusClipping: String,
    val statusLowSnr: String,
    val statusCalm: String,
    val statusMildFluctuation: String,
    val statusFearSingle: String,
    val statusStressSingle: String,
    val statusPressureSingle: String,
