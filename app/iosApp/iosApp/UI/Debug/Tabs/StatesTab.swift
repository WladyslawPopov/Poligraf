            ...
            VStack(spacing: 16) {
                DebugSection(title: "Engine States", designSystem: designSystem) {
                    DebugActionButton(
                        ...
                        action: { component.onAction(action: .debugTriggerLoading) }
                    )
                    ...
                    DebugActionButton(
                        ...
                        color: .stress,
                        designSystem: designSystem,
                        action: { component.onAction(action: .debugTriggerErrorBlocking) }
                    )
                }
                ...
                DebugSection(title: "Notifications / Toasts", designSystem: designSystem) {
                    DebugActionButton(
                        ...
                        color: .error,
                        designSystem: designSystem,
                        action: { component.onAction(action: .debugTriggerErrorNonBlocking) }
                    )
                    ...
                    DebugActionButton(
                        ...
                        color: .truth,
                        designSystem: designSystem,
                        action: { component.onAction(action: .debugTriggerSuccessToast) }
                    )
                }
            }
