    ...
    fun getColorHex(token: ColorToken, isDark: Boolean): String {
        return if (isDark) {
            when (token) {
                ...
                ColorToken.ACCENT_ENERGY -> "#00F2FF"
            ...
            when (token) {
                ColorToken.BACKGROUND -> "#E2E8F0"
                ColorToken.SURFACE -> "#FFFFFF"
                ColorToken.SURFACE_VARIANT -> "#CBD5E1"
                ColorToken.GLASS_BASE -> "#1A000000"
                ColorToken.GLASS_BORDER -> "#33000000"
                ColorToken.PRIMARY -> "#333333"
                ColorToken.ON_PRIMARY -> "#FFFFFF"
                ColorToken.TRUTH -> "#00C853"
                ColorToken.STRESS -> "#FF5252"
                ColorToken.ACCENT_ENERGY -> "#0EA5E9"
                ColorToken.ERROR -> "#B00020"
                ColorToken.TEXT_PRIMARY -> "#000000"
                ColorToken.TEXT_SECONDARY -> "#475569"
