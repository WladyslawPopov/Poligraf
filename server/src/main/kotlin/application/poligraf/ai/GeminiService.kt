package application.poligraf.ai
...
class GeminiService {
    ...
    // 1. Specify the European multi-region
    ...
    // 3. Set the correct URL for multi-regions (using .rep.)
    ...
    suspend fun testAi(): String = withContext(Dispatchers.IO) {
        try {
            // 4. Use the official SDK PredictionServiceClient
